# Overview of Project
This study was conducted on cargo theft data from the FBI dataset. The dataset contains interesting information. Cargo stolen data is a complete FBI data set, and as a result of its examination, it is an issue that can be avoided, especially in terms of supply chains.

### Resources:
Datasets
- CT_2013_2021.csv (https://cde.ucr.cjis.gov)
